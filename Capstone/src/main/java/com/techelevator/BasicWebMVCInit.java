...
public class BasicWebMVCInit implements WebMvcConfigurer, WebApplicationInitializer{
	...
	@Bean
	public BasicDataSource stateDataSource() {
		BasicDataSource stateDataSource = new BasicDataSource();
		stateDataSource.setDriverClassName("org.postgresql.Driver");
		stateDataSource.setUrl("jdbc:postgresql://localhost:5432/world");
		stateDataSource.setUsername("postgres");
		stateDataSource.setPassword("postgres1");
